...
export function useMediaQuery(query: string, options: UseMediaQueryOptions<false>): boolean | undefined
// CSR version of useMediaQuery.
export function useMediaQuery(query: string, options?: Partial<UseMediaQueryOptions<true>>): boolean
/**
 * Custom hook for tracking the state of a media query.
 * @param {string} query - The media query to track.
...
export default function useMediaQuery(
  ...
  let initializeWithValue = typeof options === "boolean" ? undefined : options?.initializeWithValue ?? undefined
